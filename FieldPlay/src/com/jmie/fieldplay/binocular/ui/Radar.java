...
import com.jmie.fieldplay.binocular.common.Calculator;
import com.jmie.fieldplay.binocular.data.ARData;
import com.jmie.fieldplay.binocular.data.ScreenPosition;
import com.jmie.fieldplay.binocular.ui.objects.PaintableCircle;
import com.jmie.fieldplay.binocular.ui.objects.PaintableLine;
import com.jmie.fieldplay.binocular.ui.objects.PaintablePosition;
import com.jmie.fieldplay.binocular.ui.objects.PaintableRadarPoints;
import com.jmie.fieldplay.binocular.ui.objects.PaintableText;
...
public class Radar {
    ...
    private static final int RADAR_COLOR = Color.argb(100, 163, 163, 163);
    ...
    public Radar(float size) {
    	RADIUS = size;
    	TEXT_SIZE = (int)(size/5);
