...
import com.jmie.fieldplay.binocular.camera.CameraModel;
import com.jmie.fieldplay.binocular.common.Vector;
import com.jmie.fieldplay.binocular.data.ARData;
import com.jmie.fieldplay.binocular.data.PhysicalLocation;
import com.jmie.fieldplay.binocular.ui.objects.PaintableBox;
import com.jmie.fieldplay.binocular.ui.objects.PaintableBoxedText;
import com.jmie.fieldplay.binocular.ui.objects.PaintableGps;
import com.jmie.fieldplay.binocular.ui.objects.PaintableObject;
import com.jmie.fieldplay.binocular.ui.objects.PaintablePoint;
import com.jmie.fieldplay.binocular.ui.objects.PaintablePosition;
...
public class Marker implements Comparable<Marker> {
    ...
    public Marker(String name, String description, double latitude, double longitude, double altitude, int color) {
        set(name, description, latitude, longitude, altitude, color);
    }
     ...
     *            Color of the Marker.
     */
    public synchronized void set(String name, String description, double latitude, double longitude, double altitude, int color) {
    ...
    private synchronized void updateDistance(Location location) {
        if (location == null) throw new NullPointerException();
        Log.d("marker", "marker pos lat: " + physicalLocation.getLatitude() + " long: " + physicalLocation.getLongitude());
        Log.d("marker", "my position lat: " + location.getLatitude() + " long: " + location.getLongitude());
    ...
    protected synchronized void drawIcon(Canvas canvas) {
       ...
       // if (gpsSymbol == null) gpsSymbol = new PaintableGps(18, 8, true, getColor());
        if (gpsSymbol == null) gpsSymbol = new PaintableGps(18, 8, true, getColor());
