...
import com.jmie.fieldplay.binocular.ui.Radar;
...
public class PaintableRadarPoints extends PaintableObject {
	public static String TAG = "Radar Points";
    ...
    public void paint(Canvas canvas) {
        ...
        for (Marker pm : ARData.getMarkers()) {
            ...
            if ((x*x + y*y) < (Radar.RADIUS * Radar.RADIUS)) {
                if (paintablePoint == null) paintablePoint = new PaintablePoint(pm.getColor(), true, (int)Radar.RADIUS/20);
