...
public final class GeofenceUtils {
    ...
    public static final String ACTION_CONNECTION_ERROR =
            "com.jmie.fieldplay.geofence.ACTION_CONNECTION_ERROR";

    public static final String ACTION_CONNECTION_SUCCESS =
            "com.jmie.fieldplay.geofence.ACTION_CONNECTION_SUCCESS";

    public static final String ACTION_GEOFENCES_ADDED =
            "com.jmie.fieldplay.geofence.ACTION_GEOFENCES_ADDED";

    public static final String ACTION_GEOFENCES_REMOVED =
            "com.jmie.fieldplay.geofence.ACTION_GEOFENCES_DELETED";

    public static final String ACTION_GEOFENCE_ERROR =
            "com.jmie.fieldplay.geofence.ACTION_GEOFENCES_ERROR";

    public static final String ACTION_GEOFENCE_TRANSITION =
            "com.jmie.fieldplay.geofence.ACTION_GEOFENCE_TRANSITION";

    public static final String ACTION_GEOFENCE_TRANSITION_ERROR =
                    "com.jmie.fieldplay.geofence.ACTION_GEOFENCE_TRANSITION_ERROR";

    // The Intent category used by all Location Services sample apps
    public static final String CATEGORY_LOCATION_SERVICES =
                    "com.jmie.fieldplay.geofence.CATEGORY_LOCATION_SERVICES";

    // Keys for extended data in Intents
    public static final String EXTRA_CONNECTION_CODE =
                    "com.jmie.fieldplay.EXTRA_CONNECTION_CODE";

    public static final String EXTRA_CONNECTION_ERROR_CODE =
            "com.jmie.fieldplay.geofence.EXTRA_CONNECTION_ERROR_CODE";

    public static final String EXTRA_CONNECTION_ERROR_MESSAGE =
            "com.jmie.fieldplay.geofence.EXTRA_CONNECTION_ERROR_MESSAGE";

    public static final String EXTRA_GEOFENCE_STATUS =
            "com.jmie.fieldplay.geofence.EXTRA_GEOFENCE_STATUS";

    /*
     * Keys for flattened geofences stored in SharedPreferences
     */
    public static final String KEY_ROUTE_NAME = "com.jmie.fieldplay.geofence.KEY_ROUTE_NAME";
    public static final String KEY_LOCATION_NAME = "com.jmie.fieldplay.geofence.KEY_LOCATION_NAME";
    public static final String KEY_LATITUDE = "com.jmie.fieldplay.geofence.KEY_LATITUDE";

    public static final String KEY_LONGITUDE = "com.jmie.fieldplay.geofence.KEY_LONGITUDE";

    public static final String KEY_RADIUS = "com.jmie.fieldplay.geofence.KEY_RADIUS";

    public static final String KEY_EXPIRATION_DURATION =
            "com.jmie.fieldplay.geofence.KEY_EXPIRATION_DURATION";

    public static final String KEY_TRANSITION_TYPE =
            "com.jmie.fieldplay.geofence.KEY_TRANSITION_TYPE";
    public static final String KEY_FENCE_COUNT = "com.jmie.fieldplay.geofence.KEY_FENCE_COUNT";
